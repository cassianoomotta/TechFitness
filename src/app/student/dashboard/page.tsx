...
export default function StudentDashboard() {
  ...
  // Identificação do último treino concluído para seleção inteligente da rotina na Home
  const [lastCompletedPlanId, setLastCompletedPlanId] = useState<string | null>(() => {
    if (typeof window === "undefined") return null;
    try {
      return localStorage.getItem("tf_last_completed_plan_id");
    } catch {
      return null;
    }
  });
  ...
  const suggestedPlan = useMemo(() => {
    ...
    // Se ainda não houver último treino registrado, tenta encaixar pelo dia da semana de hoje
