          ...
          >
            ...
            <div className="flex justify-between items-start gap-4">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  type="button"
                  onClick={() => setSelectedMuscleGroupForMap(exercise.muscleGroup)}
                  className="p-1.5 rounded-lg bg-white text-[#94A3B8] hover:text-[#2563EB] hover:bg-[#2563EB]/5 transition-colors cursor-pointer"
