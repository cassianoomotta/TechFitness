...
export default function MuscleMap({ muscleGroup, className = "", size = 200 }: MuscleMapProps) {
  ...
  // Cores Tailwind Dinâmicas baseadas na TechFitness (Azul Vibrante e contornos limpos)
    ...
    <div className={`flex items-center justify-center gap-8 bg-white dark:bg-zinc-950 p-4 rounded-2xl border border-slate-100 dark:border-zinc-900 shadow-inner ${className}`} style={{ height: size + 40 }}>
      ...
      <div className="flex flex-col items-center">
        ...
        >
          ...
          {/* Ombros (Deltoides) */}
          <path d="M 35,35 C 30,37 27,42 27,52 C 27,58 29,60 32,58 C 34,53 34,44 35,35 Z" className={getFillClass(highlightShoulders)} />
          <path d="M 65,35 C 70,37 73,42 73,52 C 73,58 71,60 68,58 C 66,53 66,44 65,35 Z" className={getFillClass(highlightShoulders)} />
          ...
          <path d="M 32,58 C 30,61 29,66 30,76 C 31,79 34,79 35,76 C 36,68 35,61 32,58 Z" className={getFillClass(highlightBiceps)} />
          <path d="M 68,58 C 70,61 71,66 70,76 C 69,79 66,79 65,76 C 64,68 64,61 68,58 Z" className={getFillClass(highlightBiceps)} />

          {/* Antebraços */}
          <path d="M 30,76 L 24,111 C 25,113 27,113 28,111 L 35,76 Z" className={getFillClass(highlightForearms)} />
          <path d="M 70,76 L 76,111 C 75,113 73,113 72,111 L 65,76 Z" className={getFillClass(highlightForearms)} />

          {/* Mãos */}
          <path d="M 24,111 C 22,118 23,124 26,124 C 28,122 28,114 28,111 Z" className={neutroClass} />
          <path d="M 76,111 C 78,118 77,124 74,124 C 72,122 72,114 72,111 Z" className={neutroClass} />
      ...
      <div className="flex flex-col items-center">
        ...
        >
          ...
          <path d="M 32,58 C 30,61 29,66 30,76 C 31,79 34,79 35,76 C 36,68 35,61 32,58 Z" className={getFillClass(highlightTriceps)} />
          <path d="M 68,58 C 70,61 71,66 70,76 C 69,79 66,79 65,76 C 64,68 64,61 68,58 Z" className={getFillClass(highlightTriceps)} />
